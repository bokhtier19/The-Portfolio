			...
			<div className='flex justify-center my-20 scroll-mt-24' id='about'>
				<div className='flex flex-col md:flex-row items-center md:justify-around'>
					<div className='text-center'>
						<h1 className='anton-regular'>About Me</h1>
					</div>
					<div className='w-5/6 md:w-3/5 text-center'>
						<div>
						...
						<div className='flex flex-col justify-around gap-4 my-8 md:flex-row'>
							<div className='flex-1 p-4 border-2 border-gray-600 rounded-md'>
							...
							<div className='flex-1 p-4 border-2 border-gray-600 rounded-md'>
								...
								<p className='text-center'>B.Tech in Electronics Engineering</p>
							</div>
							<div className='flex-1 p-4 border-2 border-gray-600 rounded-md'>
								<div className='flex items-center justify-center'>
